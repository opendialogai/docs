...
For a full breakdown of all available contexts, their scope, and usage examples, see [Contexts](contexts.md).

For information on attribute types, naming, and how to create and manage attributes, see [About attributes](about-attributes.md).