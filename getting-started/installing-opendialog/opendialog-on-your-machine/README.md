...
2. If you are looking to develop using the OpenDialog conversational framework and write specific OpenDialog extensions then the [local dev environment guide](local-dev-environment-for-development.md) is for you. 
