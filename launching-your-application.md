---
description: Description of how to launch your conversational application.
---

# Launching Your Application

This section outlines how to launch your conversational application.

### OpenDialog's WebChat

#### Publish the Scenario

To launch your conversational application using the OpenDialog WebChat on your website or application you first need to activate the scenario you want to launch. If you have not so already, you can do this by going to the 'Scenarios' page within the Designer and click on the slider which will turn green.
