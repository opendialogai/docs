---
title: Adding a structured conversation
...
:::note
For an AI Agent that is mainly focussed on process-handling, we recommend using the prebuilt [process-handling AI Agent](/getting-started-1/quick-start-ai-agents/a-process-handling-ai-agent).
:::
...
1 - Add the AppointmentBooking as [a new topic of discussion](/tutorials/add-a-new-topic-of-discussion). These steps are covered in the dedicated tutorial. Click the link for a [refresher](/tutorials/add-a-new-topic-of-discussion), and follow all the outlined steps 👉🏻
...
* This scene being the first one you want to start the conversation with, make sure to click the checkbox next to 'Starting' under the [Behaviour](/core-concepts/how-the-conversation-engine-thinks) title.
...
* This turn being the first one you want to start the scene with, make sure to click the checkbox next to 'Starting' under the [Behaviour](/core-concepts/how-the-conversation-engine-thinks) title.
...
This template can now be expanded or duplicated to build out more complex processes. Remember, [testing](/tutorials/test-and-tweak-your-ai-agent) is your friend—use the tools provided to ensure a seamless experience for your users. 🎉
