---
title: Add a 3rd party integration
...
* with LLM's through **LLM actions,** which we covered [here](/getting-started-1/quick-start-ai-agents/the-start-from-scratch-ai-agent/supporting-llm-actions) and you can learn more about [here](/opendialog-platform/interpreters-and-natural-language-understanding/llm-actions).
* through **prebuilt actions**, which you can read more about [here](/opendialog-platform/actions/actions-from-library).
...
![](~/assets/opendialog-actions-122024.png)
...
![](~/assets/opendialog-actions-2.png)
