...
<iframe src="https://www.youtube-nocookie.com/embed/EwM5A6QNEFA" title="Follow this video to add and use a knowledge source for RAG" loading="lazy" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
<figcaption>Follow this video to add and use a knowledge source for RAG</figcaption>
</figure>

## **Step by step guide**

![](~/assets/rag-diagram.png)
...
![Creating a static topic](~/assets/image-612.png)
