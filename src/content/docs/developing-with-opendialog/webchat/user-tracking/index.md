---
title: User Tracking
description: There are data layer variables pre-set within WebChat to enable user tracking data to be passed into Tag Manager and then into Google Analytics instances.
---
