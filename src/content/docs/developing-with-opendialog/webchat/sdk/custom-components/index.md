...
description: This section describes how you can pass in your own message types to be rendered in the WebChat application.
---
...
For more info about the current message types, response types and their data structure, explore our [ChatAPI documentation](/developing-with-opendialog/webchat/webchat-api).
...
```html title="LocationMessage.vue"
<template>
