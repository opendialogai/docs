...
![](~/assets/screenshot-2023-06-01-at-10-05-01.png)
...
Then, enter your Freshdesk account's URL and API token (see [above](/opendialog-platform/actions/actions-from-library/freshdesk-action#what-youll-need) for where to find this information).
...
*Test your action using test action pane*
...
![](~/assets/screenshot-2023-06-02-at-10-02-49.png "375")
...
You can reference the [Integrate and Action](/opendialog-platform/actions) introduction for more information on how to use actions in your scenarios.
