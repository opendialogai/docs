---
title: Using JMESPath expressions
---
...
You can create [a from message with dynamic](/opendialog-platform/conversation-designer/message-design/message-types/form-message#creating-form-messages-with-dynamic-data) data retrieved from a webhook action. For example:
