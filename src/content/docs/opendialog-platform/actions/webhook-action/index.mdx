...
![Authentication method selection showing Header, mTLS, and OAuth2 options](/.gitbook/assets/authentication_selection.png)
...
![Header Authentication configuration](/.gitbook/assets/authenticaton_headers.png)
...
![mTLS Authentication configuration](/.gitbook/assets/authentication_mtls.png)
...
![OAuth2 Client Credentials configuration showing token URL, client ID, client secret with a secret reference, and scope](</.gitbook/assets/oauth2 config.png>)
