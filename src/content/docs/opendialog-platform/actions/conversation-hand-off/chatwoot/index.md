---
title: Chatwoot
description: This section outlines how you can set up a handoff to live agents using a Chatwoot integration.
---
...
Provide the necessary [account details](/opendialog-platform/actions/conversation-hand-off/chatwoot#what-youll-need) to set up your integration.  Hit 'Save' to set up this integration to use in your scenario.
