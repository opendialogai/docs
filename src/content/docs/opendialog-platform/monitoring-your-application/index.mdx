...
![](</.gitbook/assets/Screenshot 2024-09-26 at 10.28.52.png>)
...
<CardGrid>
  <LinkCard title="Project usage" description="The project usage graph shows both the number of users and the number of requests for any given date or range of dates. It can also be expanded for a more focused and in-depth visualisation." href="/opendialog-platform/monitoring-your-application#project-usage" />
  <LinkCard title="Interaction logs" description="The interaction logs are listed and filtered by date, with the most recent appearing at the top. Each interaction log can be expanded to review specific conversations." href="/opendialog-platform/monitoring-your-application#interaction-logs" />
  <LinkCard title="Message log table" description="The message logs are listed and filtered by date, with the most recent appearing at the top. Messages can also be filtered by Conversation, Scene, Turn and Intent to find specific results." href="/opendialog-platform/monitoring-your-application#message-table" />
</CardGrid>
...
![](</.gitbook/assets/Screenshot 2024-09-26 at 10.32.32.png>)
...
![](</.gitbook/assets/Screenshot 2024-10-01 at 15.31.13.png>)
...
![](</.gitbook/assets/Screenshot 2024-10-01 at 15.31.33.png>)
...
![](</.gitbook/assets/Screenshot 2024-10-01 at 15.32.22.png>)
...
The [Interaction API](/developing-with-opendialog/interaction-api) enables retrieving information about interactions between the user and OpenDialog scenarios. The data is requested for over a time period ( `from` , `to` ) and is split by `user_id` . You can check out the Interaction API documentation through this [link](/developing-with-opendialog/interaction-api).
