...
![](~/assets/designoption-notexpanded.png)
...
![](~/assets/screenshot-2024-06-05-at-15-36-41.png)
...
![](~/assets/screenshot-2025-03-06-at-11-09-33-1.png)
...
<CardGrid>
  <CoverCard title="Tailor the user experience" description="Master the art of crafting powerful messages tailored to your specific needs, utilising OpenDialog's diverse range of message types to their fullest potential." href="/opendialog-platform/conversation-designer/message-design/constructing-messages" cover="/src/assets/legoblocks.png" />
