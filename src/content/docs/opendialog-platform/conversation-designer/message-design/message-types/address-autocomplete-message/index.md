---
title: Address Autocomplete Message
...
Navigate to the [Message Editor](/opendialog-platform/conversation-designer/message-design/message-editor) and create a _Custom Message._ Select `address-autocomplete-message` from the message type drop down menu and the XML Snippet field will automatically be populated with a code template.

Fill in the template with the [properties](/opendialog-platform/conversation-designer/message-design/message-types/address-autocomplete-message#properties) of your particular message and when you are happy with it make sure to save your message and test it in the Test Preview chat window.

![](~/assets/group-30.png)

*How to create an address autocomplete message via a custom message*
...
[https://www.fetchify.com/address-auto-complete](https://www.fetchify.com/address-auto-complete)
