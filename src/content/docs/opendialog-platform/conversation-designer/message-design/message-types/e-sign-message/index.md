...
![](~/assets/screenshot-2024-06-04-at-11-25-53.png "209")

*Here is where the user can input their signature*

![](~/assets/screenshot-2024-06-04-at-11-26-02.png "209")

*An example of a user signature that's been inputted*

![](~/assets/e-sign.png "210")
...
Navigate to the [Message Editor](/opendialog-platform/conversation-designer/message-design/message-editor) and create a _Custom Message._ Copy the [XML snippet](/opendialog-platform/conversation-designer/message-design/message-types/e-sign-message#xml-snippet) at the bottom of this page into the black box, or select `esign-message` from the drop down, and your chat message will appear in the Preview panel.

Fill in the template with the [properties](/opendialog-platform/conversation-designer/message-design/message-types/e-sign-message#properties) of your particular message and when you are happy with it make sure to save your message and test it in the Test Preview chat window.
