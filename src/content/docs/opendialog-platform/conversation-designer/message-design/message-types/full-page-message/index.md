...
Navigate to the [Message Editor](/opendialog-platform/conversation-designer/message-design/message-editor) and create a _Custom Message._ Select `fp-rich-message` from the message type drop down menu and the XML Snippet field will automatically be populated with a code template.

Fill in the template with the [properties ](/opendialog-platform/conversation-designer/message-design/message-types/full-page-message#properties)of your particular message and when you are happy with it make sure to save your message and test it in the Test Preview chat window.

![](~/assets/group-12.png)

*How to create a full page rich message in the custom message editor*
...
Navigate to the [Message Editor](/opendialog-platform/conversation-designer/message-design/message-editor) and create a _Custom Message._ Select `fp-form-message` from the message type drop down menu and the XML Snippet field will automatically be populated with a code template.

Fill in the template with the [properties ](/opendialog-platform/conversation-designer/message-design/message-types/full-page-message#properties)of your particular message and when you are happy with it make sure to save your message and test it in the Test Preview chat window.

![](~/assets/group-13.png)

*How to create a full page form message in the custom message editor*
