...
All of these controls can be customised through the [webchat interface settings](/opendialog-platform/conversation-designer/webchat-interface-design/webchat-interface-settings) page.
...
![](~/assets/group-5.png "375")

*Where to find the main menu button - right top hand corner*

Next to the minimise icon, there is the main chatbot control menu. What goes into this menu is customisable by you in the [Interface Settings](/opendialog-platform/conversation-designer/webchat-interface-design/webchat-interface-settings) section of the conversation engine. From here, you can choose to have the following actions available from within your main menu:
...
![](~/assets/screenshot-2024-04-25-at-22-56-32.png "375")
...
You are also able to customise the look and feel of your CTA button. This can be done via the [webchat interface settings](/opendialog-platform/conversation-designer/webchat-interface-design/webchat-interface-settings) section of the conversation engine. <br>
