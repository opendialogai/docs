...
![The Semantic intent classifier, showing a list of intents and sub intents with instructions ](~/assets/screencapture-semantic-classifiers-cloud-dev1-engineering-opendialog-app-admin-semantic-classifiers-2251799814000009-intents-2024-09-05-09-54-06.png)
...
![The language services landing page within the Open Dialog product - showing a semantic classifier ](~/assets/screencapture-semantic-classifiers-cloud-dev1-engineering-opendialog-app-admin-language-services-type-2024-09-05-09-54-57.png)
...
![The Semantic intent classifier screen displays all the configuration options available including name, description and LLM engine](~/assets/screencapture-semantic-classifiers-cloud-dev1-engineering-opendialog-app-admin-semantic-classifiers-new-2024-09-05-09-56-18.png)
...
![Adding intents and sub intents into a Semantic intent classifier using names and instructions to support matching](~/assets/screencapture-semantic-classifiers-cloud-dev1-engineering-opendialog-app-admin-semantic-classifiers-2251799814000009-intents-2024-09-05-09-57-33.png)
...
![Editing intents using the user interface tools](~/assets/screencapture-semantic-classifiers-cloud-dev1-engineering-opendialog-app-admin-semantic-classifiers-2251799814000009-intents-2024-09-05-09-58-09.png)
...
![](~/assets/screencapture-semantic-classifiers-cloud-dev1-engineering-opendialog-app-admin-semantic-classifiers-2251799814000009-prompt-2024-09-05-09-58-53.png)
...
![Creating a new interpreter and selecting the Semantic intent classifier language service ](~/assets/screencapture-semantic-classifiers-cloud-dev1-engineering-opendialog-app-admin-interpreters-configure-1125899907000034-2024-09-05-09-59-52.png)
...
![The opendialog conversation designer, showing an open side user intent side bar ](~/assets/screenshot-2024-09-03-at-13-04-59.png)
