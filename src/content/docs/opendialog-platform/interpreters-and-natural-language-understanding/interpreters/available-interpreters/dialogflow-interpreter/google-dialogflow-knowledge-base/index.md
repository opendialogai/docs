---
title: Google Dialogflow Knowledge Base
---
...
<video autoplay loop muted playsinline aria-label="DialogFlow Knowledge Base Demo" src="/media/knowledge-base-demo.mp4"></video>
...
![Mapping FAQ intents](~/assets/image-459.png)
...
![](~/assets/od-kamau-cloud-opendialog-ai-admin-interpreters-mapping-99-scenario-0x13c2efa-1.png)

Create a new turn in the called "FAQ".

![](~/assets/od-kamau-cloud-opendialog-ai-admin-conversation-builder-scene-0x13c2efd-scenario-0x13c2efa-1.png)
...
![](~/assets/od-kamau-cloud-opendialog-ai-admin-conversation-builder-scene-0x13c2efd-scenario-0x13c2efa-7.png)
...
![](~/assets/od-kamau-cloud-opendialog-ai-admin-conversation-builder-scene-0x13c2efd-scenario-0x13c2efa-8.png)

After you've saved the response intent, edit the message. Delete the text message and add a custom attribute message.

![](~/assets/2023-06-09-15-46-54.png)
...
![](~/assets/2023-06-09-15-27-50.png)
...
![](~/assets/od-kamau-cloud-opendialog-ai-admin-demo-scenario-0x13c2efa-3.png)
