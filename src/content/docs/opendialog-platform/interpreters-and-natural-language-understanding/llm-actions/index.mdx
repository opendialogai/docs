...
![An LLM action set up showing configuration form fields](/.gitbook/assets/LLMActions_TestPanel.png)
...
![The OpenDialog product showing where in the menu &#x27;LLM actions&#x27; can be found](</.gitbook/assets/Actions landing page.png>)
...
![](</.gitbook/assets/LLMAction_Setup (1).png>)
...
![](</.gitbook/assets/LLMAction_basicprompt config.png>)
...
![](</.gitbook/assets/LLMAction_basicprompt config with attributes.png>)
...
![](/.gitbook/assets/LLMActions_AdvancedSettings.png)
...
![](</.gitbook/assets/LLMActions_AttributesforReuse - 1.png>)
...
![](</.gitbook/assets/LLMActions_AttributesforReuse -2 - in Messages.png>)
...
![](/.gitbook/assets/LLMActions_safeguarding.png)
...
![](/.gitbook/assets/LLMActions_TestPanel.png)
