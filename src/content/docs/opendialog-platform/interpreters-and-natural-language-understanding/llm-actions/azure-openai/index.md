...
![](</.gitbook/assets/Screenshot 2024-07-08 at 18.30.02.png>)
...
Instead of pasting your API key directly, you can reference a secret stored in the [Secret Context](/core-concepts/contexts-and-attributes/secret-context). This keeps your credentials encrypted and centralised.
...
![](</.gitbook/assets/Screenshot 2024-07-09 at 09.52.58.png>)
...
You can check if your action is successful by testing your conversation in the Preview (Test - Preview) and checking the user context on the right side of your screen. When you match the intent with the action then the user context will update to include `action_success: true` as well as any other [output attributes](/opendialog-platform/interpreters-and-natural-language-understanding/llm-actions#use-custom-output-attributes), such as `llm_response`.
