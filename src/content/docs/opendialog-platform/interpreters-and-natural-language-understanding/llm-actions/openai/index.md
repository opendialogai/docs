...
Instead of pasting your API key directly, you can reference a secret stored in the [Secret Context](/core-concepts/contexts-and-attributes/secret-context). This keeps your credentials encrypted and centralised rather than stored as plain text in the configuration.
