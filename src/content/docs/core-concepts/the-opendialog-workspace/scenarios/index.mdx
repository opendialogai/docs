...
<CardGrid>
  <CoverCard title="The OpenDialog model" description="Take a deepdive into the underpinning model for OpenDialog applications." href="/core-concepts/the-opendialog-model" cover="/src/assets/od-basicmodel.png" />
  <CoverCard title="Designing your application" description="Create a new scenario from a template or from scratch using OpenDialog's model and best practices." href="/opendialog-platform/conversation-designer" cover="/src/assets/applicationdesign.png" />
</CardGrid>
