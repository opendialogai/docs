...
<CardGrid>
  <CoverCard title="Leveraging Generative AI" description="Learn how to use OpenDialog's language services to create custom ready-to-use language capabilities" href="/opendialog-platform/interpreters-and-natural-language-understanding" cover="/src/assets/engineer-maintenancing-ai-systems-2023-11-27-05-12-07-utc.jpg" />
  <CoverCard title="Using language services" description="Add a language service to your scenario to interpret what end-users input into your conversational application." href="/opendialog-platform/interpreters-and-natural-language-understanding/interpreters/using-a-language-service-interpreter" cover="/src/assets/usinglanguageservice.png" />
</CardGrid>
