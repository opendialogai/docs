...
:::note
See the [Attribute Management](/core-concepts/contexts-and-attributes/attribute-management) section on how to access attributes and create new ones.
:::
...
Attributes are stored in contexts. Different contexts can be used to separate different types of information as described in the [Contexts](/core-concepts/contexts-and-attributes/contexts) page.
...
Secret String attributes are stored in the [Secret Context](/core-concepts/contexts-and-attributes/secret-context) and can be referenced using `{secret.attribute_name}`.
...
Certificates are stored in the [Secret Context](/core-concepts/contexts-and-attributes/secret-context) and support multiple formats including P12, PFX, PEM, CER, CRT, and KEY.
...
:::note
For details on how to create and manage secrets and certificates, see the [Secret Context](/core-concepts/contexts-and-attributes/secret-context) documentation.
:::
...
To define and use attributes, you can check detailed instructions in the [Attribute Management](/core-concepts/contexts-and-attributes/attribute-management) section of this documentation.
