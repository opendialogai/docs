...
![Secret Management page showing a list of secrets and certificates with their types, dates, and expiration](~/assets/secret-managemnet.png)
...
![Certificate detail page showing metadata including format, fingerprint, subject CN, expiration date, and validity status](~/assets/certificate-management.png)
