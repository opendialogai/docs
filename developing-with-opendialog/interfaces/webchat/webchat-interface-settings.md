...
The Interface Settings section of the OpenDialog admin is where you go to customise how the widget looks and behaves before [embedding](load-webchat-within-a-page-element.md) it on your webpage.
