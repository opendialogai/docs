...
![Scenario Top Level view - Message icon in action bar](../../.gitbook/assets/image%20%28175%29.png)
...
![Message Editor](../../.gitbook/assets/image%20%28174%29.png)

An intent can be associated with multiple messages as we typically want to customize messages to specific users. For example, we could have different messages for logged-in users vs those not logged in. We can define what message are shown through conditions. 
