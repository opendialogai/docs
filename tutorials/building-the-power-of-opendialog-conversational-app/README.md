...
Before you dive into the tutorial you can see The Power of OpenDialog in action on our [website](https://opendialog.ai/the-power-of-opendialog/). This will be a good reference for you whilst you're building out your own version of the application.
...
{% content-ref url="lesson-2-buiding-intents.md" %}
[lesson-2-buiding-intents.md](lesson-2-buiding-intents.md)
{% endcontent-ref %}

{% content-ref url="lesson-3-creating-messages-and-buttons.md" %}
[lesson-3-creating-messages-and-buttons.md](lesson-3-creating-messages-and-buttons.md)
{% endcontent-ref %}
