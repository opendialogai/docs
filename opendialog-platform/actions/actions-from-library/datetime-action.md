...
{% hint style="info" %}
Any new timestamp attributes that you create and/or reference with this action type should be [registered](../../../core-concepts/contexts-and-attributes/attribute-management.md#creating-a-new-dynamic-attribute) as Timestamp attributes.
{% endhint %}
...
* `modifier`: This is an optional field. If it is provided it should be a representation of how you would like to update the base, or current, time, e.g. `+1 week`. See below for a [list of further examples](datetime-action.md#modifier-examples). If it is not provided the base timestamp will not be amended.

<figure><img src="../../../.gitbook/assets/Screenshot 2025-07-11 at 11.59.08.png" alt=""><figcaption></figcaption></figure>
