# The "Start from Scratch" Scenario Explained
...
* Global No Match: A global no match conversation to deal with No Matches from our interpreters if they are not specifically dealt with in other conversations. You can learn about the No Match intent [here](../conversation-designer/conversation-design/conversational-patterns/building-robust-assistants/contextual-no-match-pattern.md).
