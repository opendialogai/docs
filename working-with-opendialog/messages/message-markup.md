...
![Simple Messages](https://docs.opendialog.ai/docs/assets/messages/simple-messages.png)
...
![Simple Message](https://docs.opendialog.ai/docs/assets/messages/text-message.png)
...
![Message with link](https://docs.opendialog.ai/docs/assets/messages/message-with-link.png)
...
![Image message](https://docs.opendialog.ai/docs/assets/messages/image-message.png)
...
![One Button Message](https://docs.opendialog.ai/docs/assets/messages/one-button-message.png)
...
![Two Button Message](https://docs.opendialog.ai/docs/assets/messages/two-button-message.png)
...
![Link Button Message](https://docs.opendialog.ai/docs/assets/messages/button-with-links.png)
...
![Rich Message](https://docs.opendialog.ai/docs/assets/messages/rich-message.png)
...
![Form Message](https://docs.opendialog.ai/docs/assets/messages/form-message.png)
...
![List Message](https://docs.opendialog.ai/docs/assets/messages/list-message.png)
...
![date picker message](https://docs.opendialog.ai/docs/assets/messages/date_picker.png)
...
Autocomplete closed![auto complete message](https://docs.opendialog.ai/docs/assets/messages/autocomplete_message.png)

Autocomplete With Suggestions![auto complete message](https://docs.opendialog.ai/docs/assets/messages/autocomplete_message_open.png)
...
![Longtext Message](https://docs.opendialog.ai/docs/assets/messages/longtext-message.png)
...
![CTA message](https://docs.opendialog.ai/docs/assets/messages/cta-message.png)
...
![meta message](https://docs.opendialog.ai/docs/assets/messages/meta_message.png)
