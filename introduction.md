...
In this section we are going to provide a high-level, quick fire overview of these concepts and in subsequent sections we dive into the specific details of each. 
