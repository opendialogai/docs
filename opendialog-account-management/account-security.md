---
description: 2 Factor Authentication for you user account
---

# Account Security

To help with increasing the security of your OpenDialog instance, each user is able to individually set-up and use 2 factor authentication on their accounts. In the future, once there is role based access, we will be able to allow admins to set organisation wide policies such as 2FA required for all users.
...
![Navigation: User menu](../.gitbook/assets/image%20%28395%29.png)
...
1. Contact [Support@OpenDialog.ai](mailto:Support@OpenDialog.ai%20) and incl. your instance ID within the email.
